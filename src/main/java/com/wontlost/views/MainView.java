...
import com.wontlost.views.des.DesDecView;
import com.wontlost.views.des.DesEncView;
...
public class MainView extends AppLayout{
    ...
    private static Tab[] getAvailableTabs() {
        ...
        tabs.add(createTab(TITLE_DESENC_EDITOR, VaadinIcon.FILE_CODE, DesEncView.class));
        tabs.add(createTab(TITLE_DESDEC_EDITOR, VaadinIcon.FILE_FONT, DesDecView.class));
